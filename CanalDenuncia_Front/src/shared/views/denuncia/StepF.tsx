...
export default function StepF({ protocolo }: StepFProps) {
  ...
  return (
    <Box sx={{ width: "auto", height: "auto", margin: "0 auto" }}>
      <Box sx={{ padding: "1rem", width: "100%", backgroundColor: "#10b981", borderRadius: "8px 8px 0 0", color: "white", textAlign: "center" }}>
      ...
      <Box sx={{ backgroundColor: "white", padding: "2rem", textAlign: "center" }}>
        <Stack spacing={4} sx={{ maxWidth: 700, margin: "0 auto" }}>
          ...
          <Paper variant="outlined" sx={{ p: 3, backgroundColor: "#f0fdf4", borderColor: "#a7f3d0", borderRadius: "12px", maxWidth: 500, margin: "0 auto", width: "100%" }}>
